...
\titlegraphic{\hspace*{-10mm}\vspace*{-7mm}\includegraphics[width=12.8cm, height=3cm]{bonn2.png}}
...
{}
\makeatother 
% if you want to remove the navigation symbole uncomment the following line 
...
\title[An ILR Theme for Beamer \LaTeX]{An ILR Theme for Beamer  \LaTeX} % The short title appears at the bottom of every slide, the full title is only on the title page
\subtitle{Presentation}
\author[Your short name ]{Your full Name (Msc) } % Your name
\institute[YIN] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{

{\normalsize Doctoral Seminar\textbackslash Doctoral Defence}\\
\vspace{10pt}

\includegraphics[scale=0.3]{logo_cmb}
...
\begin{frame}{Research questions}
    \begin{tikzpicture}[
        ...
        every node/.style={color=ilrcyan},
        dot/.style={circle,fill=ilrcyan,minimum size=4pt,inner sep=0pt,
            outer sep=-1pt},
    ]
    % axis
    ...
    \draw[->, very thick, ilrorange, >=stealth']
